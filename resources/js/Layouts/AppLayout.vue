<template>
  <div>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white border-bottom sticky-top">
      <div class="container">
        <!-- Logo -->
        <Link class="navbar-brand me-4" :href="route('post.index')">
          <jet-application-mark width="100" />
        </Link>
 ...
 <div v-if="show" class="err" @click="difi">{{$page.props.flash.message}}</div>
  </transition>
      <slot></slot>
    </main>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      show:this.$page.props.flash.message
    }
  },
